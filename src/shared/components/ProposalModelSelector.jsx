...
const PROPOSAL_MODELS = [
  {
    ...
    group: 'Industrial',
    description: 'Cores fortes (Azul Marinho/Laranja), fontes Sans-Serif robustas, tabelas com linhas bem marcadas.',
    colors: ['#1A5276', '#E87722'],
  },
  {
    id: 'industrial_tech',
    name: 'Industrial Tech',
    group: 'Industrial',
    description: 'Tons de cinza e ciano, visual moderno com bordas finas, foco em cronogramas e detalhes técnicos.',
  ...
  },
  {
    ...
    group: 'Industrial',
    description: 'Visual sóbrio, preto e branco com um único acento de cor, tipografia clássica.',
  ...
  },
  {
    ...
    group: 'Clean',
    description: 'Tons pastéis, dourado e champanhe, fontes Serifadas elegantes, espaçamento generoso.',
    colors: ['#F7E7CE', '#C5A059'],
  },
  {
    id: 'clean_salmon',
    name: 'Clean Salmon',
    group: 'Clean',
    description: 'Paleta salmão e cinza quente, visual minimalista e acolhedor.',
    colors: ['#FF8C7A', '#5D5D5D'],
  },
  {
    id: 'clean_minimal',
    name: 'Clean Minimal',
    group: 'Clean',
    description: 'Foco total no conteúdo, muito espaço em branco, tipografia moderna e leve.',
